	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                ...
                int pButtonId = mPriorityRadioGroup.getCheckedRadioButtonId();
                Priority priority = pButtonId == R.id.lowPriority ? Priority.LOW : pButtonId == R.id.highPriority ? Priority.HIGH : Priority.MED;

				// Get the current Status
				Status status = mStatusRadioGroup.getCheckedRadioButtonId() == R.id.statusDone ? Status.DONE : Status.NOTDONE;
